...
const jungpflanzenImage = getImageWithFallback(
  "Jungpflanzen.WebP",
  "jungpflanzen.svg",
);
const exkursionenImage = getImageWithFallback(
  "Exkursionen1.WebP",
  "exkursionen.svg",
);
...
const erntedankfestImage = getImageWithFallback(
  "Erntedankfest.WebP",
  "ueber-uns.svg",
);
...
<template>
  <div class="space-y-16">
    ...
    <section id="ueber-uns" class="scroll-mt-24">
      <UeberUnsSection
        :image-src1="ueberUnsImage1"
        :image-src2="ueberUnsImage2"
      />
    </section>
