...
<template>
  <div class="mx-auto max-w-2xl px-4 py-20 text-center">
    <div class="rounded-2xl bg-white p-10 shadow-md dark:bg-gray-800">
      <div class="mb-6 text-5xl" aria-hidden="true">✉️</div>
      <h1 class="mb-3 text-3xl font-bold text-secondary dark:secondary-dark">
        Nachricht gesendet!
      </h1>
      ...
      <router-link to="/" class="inline-block">
        <ButtonPrimary title="Zurück zur Startseite" icon-prefix="arrow_left" />
      </router-link>
    </div>
  </div>
</template>
