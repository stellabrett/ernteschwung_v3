      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <RouterLink to="/contact" class="text-sm text-gray-400 hover:text-primary transition-colors duration-200">
                Kontakt
              </RouterLink>
            </li>
            <li>
              <RouterLink to="/about" class="text-sm text-gray-400 hover:text-primary transition-colors duration-200">
                Über uns
              </RouterLink>
            </li>
            <li>
      ...
      <div class="border-t border-gray-800 mt-10 pt-8">
        <div class="flex flex-col sm:flex-row justify-between items-center">
          ...
          <div class="flex space-x-6 mt-4 sm:mt-0">
            <a href="https://www.facebook.com/Ernteschwung" class="text-gray-500 hover:text-primary transition-colors duration-200">
            ...
            <a href="https://www.instagram.com/solawi_ernteschwung/" class="text-gray-500 hover:text-primary transition-colors duration-200">
